...
const corsOptions = {
  origin: 'https://nodejstask-front.vercel.app', // Allow requests from this origin (frontend URL)
...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://nodejstask-front.vercel.app'); // Set your frontend URL
